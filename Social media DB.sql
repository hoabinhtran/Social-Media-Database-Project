...
('Adam','https://picsum.photos/131','𝐔 𝐰𝐢𝐥𝐥 𝐟𝐢𝐧𝐝 𝐚 𝐛𝐨𝐲 𝐛𝐞𝐭𝐭𝐞𝐫 𝐭𝐡𝐚𝐧 𝐦𝐞 𝐛𝐮𝐭 𝐔 𝐝𝐨𝐧𝐭 𝐟𝐢𝐧𝐝 𝐛𝐨𝐲 𝐥𝐢𝐤𝐞 𝐦𝐞','sravi07@yahoo.com'),
...
(37,7,15,4,'Nobodys perfect…but I`m close.','akkalkot'),
...
(42,21,30,47,'Mirror: You look cute today.','alang'),
...
INSERT INTO COMMENTS(comment_text ,post_id,user_id) VALUES ('You are very trendy',100,1);
...
INSERT INTO COMMENTS(comment_text ,post_id,user_id) VALUES ('Sorry for your loss, friend. If you need to talk, I am always there for you.',48,43);
...
INSERT INTO COMMENTS(comment_text ,post_id,user_id) VALUES ('I am so happy for you.',16,24);
...
INSERT INTO COMMENTS(comment_text ,post_id,user_id) VALUES ('My word can not describe your beauty!!',67,22);
